...
@Autonomous(name = "BlueAutoRight", group = "Bot")
...
//            power = p+i+d;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            autoPilot(1.57, 2.7, 35, .8, 6);
            autoPilot(5.93, 2.6, 5, .7, 6);
            brake();
            waitMilis(1000);
            boolean quad = false;
            ...
            if (quad) {
                ...
                autoPilot(5.5, 0, 80, .85, 6);
                autoPilot(4.71, 1.57, 35, .8, 7);
                brake();
                stop();
                ...
                robot.arm.setPower(-1);
                waitMilis(300);
                autoPilot(0, 1.57, 40, .6, 4);
                robot.arm.setPower(0);
                autoPilot(4.71, 1.57, 60, .7, 5);
                brake();
                stop();
                ...
                telemetry.update();
                autoPilot(1.57, 1.57, 90, .7, 6);
                autoPilot(2.33, 1.57, 80, .7, 6);
                while (robot.rightBottomColor.blue() < 500 || robot.rightBottomColor.blue() > 1100) {
                    whileAutoPilot(1.57, 1.57, .2);
                }
                brake();
                robot.arm.setPower(1);
                autoPilot(3.14, 1.57, 80, .7, 5);
                robot.choker.setPosition(0);
                waitMilis(300);
                robot.arm.setPower(-1);
                waitMilis(500);
                autoPilot(0,1.57,130,.9,5);
                robot.arm.setPower(0);
                autoPilot(4.71,1.57,50,.4,5);
                brake();
                stop();
//                waitMilis(500);
